...
const fetchProducts = () => {
    fetch('https://dummyjson.com/products')
        ...
        window.showModal = (id, viewOnly = false) => {
            ...
            const inputs = document.querySelectorAll('#modalProduct input, #modalProduct select');
            ...
            if (viewOnly) {
                ...
                const labels = document.querySelectorAll('#modalProduct label');
                if (labels) {
        ...
        const addProduct = (event) => {
            ...
            const title = document.querySelector('#ProductModalNew').value;
            const description = document.querySelector('#DescriptionModalNew').value;
            const price = parseFloat(document.querySelector('#PriceModalNew').value);
            const discountPercentage = parseFloat(document.querySelector('#DiscountModalNew').value);
            const rating = parseFloat(document.querySelector('#RatingModalNew').value);
            const stock = parseInt(document.querySelector('#StockModalNew').value, 10);
            const brand = document.querySelector('#BrandModalNew').value;
            const category = document.querySelector('#CategoryModalNew').value;
            const thumbnail = document.querySelector('#ThumbnailModalNew').value;
            const images = document.querySelector('#ImagesModalNew').value;
